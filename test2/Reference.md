# Notes
### Gap:
- Genome-wide association studies (GWAS) have identified numerous genetic variants associated with complex diseases but mechanistic insights are impeded by the lack of understanding of how specific risk variants functionally contribute to the underlying pathogenesis

### Modalities to look for:
- Transcription factor
- alteration in chromatin state (ATAC-seq)
